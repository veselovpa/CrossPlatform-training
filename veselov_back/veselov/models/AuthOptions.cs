...
namespace veselov.Models
{
    ...
    {
        public static string Issuer => "Veselov";
        public static string Audience => "APIclients";
        public static int LifetimeInYears => 1;
        public static SecurityKey SigningKey => new SymmetricSecurityKey(Encoding.ASCII.GetBytes("12345rgulllllllllllllllllllllll"));
